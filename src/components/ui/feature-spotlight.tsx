...
export function FeaturedSpotlight({
  ...
  return (
    <div
      className={cn(
        "group relative flex cursor-pointer flex-col items-center gap-8 md:items-start md:gap-12 lg:gap-16 my-20",
    ...
    >
      ...
      <div className="relative z-10 flex w-full max-w-[320px] shrink-0 flex-col items-center text-center md:w-[240px] md:items-start md:text-left lg:w-[280px] lg:pt-4">
        ...
        <h2 className="relative">
          <span
            className="block text-4xl font-black tracking-tight text-foreground transition-all duration-700 sm:text-5xl md:text-5xl lg:text-6xl uppercase"
            style={{
          ...
          <span
            className="block text-4xl font-black tracking-tight text-orange-500 transition-all duration-700 sm:text-5xl md:text-5xl lg:text-6xl uppercase"
            style={{
