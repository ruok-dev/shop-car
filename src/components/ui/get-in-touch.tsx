...
export const ProfessionalConnect = () => {
  ...
  const socialPlatforms = [
    {
      ...
      link: 'https://www.linkedin.com/in/thiagolopes-dev/',
    ...
    },
    {
      ...
      link: 'https://github.com/ruok-dev',
    ...
    },
    {
      ...
      link: 'https://thiagojava.netlify.app/',
  ...
  return (
    <div className="bg-background overflow-hidden relative w-full py-20">
      {/* Animated Background */}
      ...
      <div className="relative z-10 flex flex-col items-center justify-center p-8">
        ...
        <div className={`text-center mb-16 transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="inline-block mb-4 px-4 py-1.5 bg-gradient-to-r from-orange-500/10 to-orange-500/10 rounded-full border border-orange-500/20">
            <span className="text-sm font-black uppercase tracking-tighter text-orange-500">
              Connect & Drive
            </span>
          </div>
          
          <h1 className="text-5xl md:text-7xl font-black mb-6 tracking-tight uppercase tracking-tighter">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed font-medium">
            Join our exclusive circle of automotive enthusiasts and stay ahead of the curve.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {socialPlatforms.map((platform, index) => (
            ...
            >
              {/* Card Container */}
              <div className="relative bg-muted/30 backdrop-blur-xl rounded-2xl p-8 border border-border/50 overflow-hidden transition-all duration-500 hover:scale-105 hover:border-orange-500/50">
                ...
                <div className="relative z-10">
                  ...
                  {/* Text */}
                  <h3 className="text-foreground font-black text-lg mb-1 transition-colors duration-300 uppercase tracking-tighter">
                    {platform.name}
                  </h3>
                  ...
                  {/* Arrow Icon */}
                  <div className="mt-4 flex items-center text-muted-foreground group-hover:text-orange-500 transition-all duration-300">
                    <span className="text-xs font-bold uppercase tracking-widest group-hover:translate-x-0 transition-all duration-300">
                      Connect
                    </span>
                    <svg 
