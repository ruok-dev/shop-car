...
const ITEMS: CollectionItem[] = [
  {
    ...
    idNumber: "001",
    image: "https://images.unsplash.com/photo-1583121274602-3e2820c69888?q=80&w=400&h=400&auto=format&fit=crop",
    icon: Car01Icon,
  },
  {
    id: "2",
    ...
    idNumber: "007",
    image: "https://images.unsplash.com/photo-1614162692292-7ac56d7f7f1e?q=80&w=400&h=400&auto=format&fit=crop",
    icon: FlashIcon,
  },
];
          ...
          <LayoutGroup>
                ...
                >
                  ...
                  <AnimatePresence mode="popLayout" initial={false}>
                    {view !== "pack" && (
                      ...
                      >
                        <div className="flex flex-col gap-0.5 min-w-0 ml-4">
                          <motion.h3
                            layout
                            className="font-black text-[15px] text-foreground leading-tight truncate uppercase tracking-tighter"
                          >
                            {item.title}
                          </motion.h3>
                          <motion.div
                        ...
                        <motion.div
                          layout
                          className="flex items-center gap-1 px-2 py-1 rounded-full bg-orange-500/10 text-orange-500 text-[10px] font-bold shrink-0 ml-2"
                        >
                          <HugeiconsIcon
                            icon={StarIcon}
                            size={10}
            ...
            <AnimatePresence>
              {view === "pack" && (
                ...
                >
                  <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-orange-500/10 text-orange-500 text-[11px] font-bold uppercase tracking-wide">
                    <HugeiconsIcon icon={Ticket01Icon} size={12} />
                    <span>Offers unlocked</span>
                  </div>
                </motion.div>
              )}
            </AnimatePresence>
  ...
  return (
    ...
    >
      {active && (
        <motion.div
          layoutId="active-tab"
          className="absolute inset-0 bg-orange-500 rounded-full shadow-md"
          transition={snappySpring}
        />
      )}
